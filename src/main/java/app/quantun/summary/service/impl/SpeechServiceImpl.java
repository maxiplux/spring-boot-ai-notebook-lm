        ...
        .voices(
            Arrays.asList(
                SsmlVoice.builder()
                    ...
                    .text(
                        "Before going any further—when we say first-time students, we mean the first time they meet you.\n"
                            + "\n"
                ...
                SsmlVoice.builder()
                    ...
                    .text(
                        " One of the most important and often neglected aspects of teaching is the element of courtesy.\n"
                            + "\n"
  ...
  public String convertTextToSpeech(String ssml, String outputFilePath) {
    ...
    try {
      ResponseEntity<byte[]> response =
          restTemplate.postForEntity(apiEndpoint + "/cognitiveservices/v1", request, byte[].class);
